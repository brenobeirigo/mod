...
exp_name = "S_LIN_C1_V=0400-0000(R)_I=5_L[3]=(01-0-, 02-0-, 03-0-)_R=([1-6, 2-6][L(05)]_T=[06h,+30m+06h+30m]_0.10(S)_1.00_0.10_A_2.40_10.00_0.00_0.00_P_B_2.40_10.00_0.00_0.00_P"
# method = "reactive"
# method = "optimal"
method = "adp/train"
...
def load_overall_stats(smooth_sigma=0):
    ...
    plot_iterations.y_range = Range1d(min(count), max(count))
    ...
    plot_iterations.extra_y_ranges["Service rate"] = Range1d(
        min(count), max(count)
    )
